...
const serviceTemplate = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>{{TITLE}} — Prasad Sawant</title>
...
<body>
  ...
  <header class="service-hero">
    <div style="position:relative; z-index:2;">
      ...
      <a class="btn btn-red" href="index.html#contact">Discuss a Project →</a>
  ...
  <footer>
    ...
    <div class="footer-copy">© 2025 Prasad Sawant</div>
  </footer>
...
<head>
  ...
  <style>
    ...
    .bh-title { font-family: var(--font-serif); font-size: clamp(42px, 5vw, 64px); line-height: 1.1; margin-bottom: 32px; color: var(--paper); font-weight: 600; }
    .bh-image { width: 100%; aspect-ratio: 21/9; background: var(--steel); margin-bottom: 60px; border-radius: 2px; }
    ...
    .blog-content h2 { font-family: var(--font-serif); font-size: 32px; color: var(--paper); margin: 60px 0 24px; font-weight: 400; }
...
<body>
  ...
  <article>
    <header class="blog-header">
      <div class="bh-meta">{{DATE}} &nbsp;·&nbsp; {{READ_TIME}} &nbsp;·&nbsp; Prasad Sawant</div>
...
const blogs = [
  {file: 'blog-single-1', title: 'Why Your Phishing Simulations Are Failing — And What To Do Instead', date: 'March 2025', readTime: '8 min read'},
...
blogs.forEach(b => {
  ...
  fs.writeFileSync('c:/Users/Prasad/Downloads/prasad-sawant-portfolio/' + b.file + '.html', content);
});
console.log("Generated sub pages!");
